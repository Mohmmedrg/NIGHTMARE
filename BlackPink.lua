------------------------------------------------
-- This Source Was Developed By (BlackPink) @Ha_ssin.--
--   This Is The Source Channel @Ha_ssin .   --
--                - 𝐍𝐈𝐆𝐇𝐓𝐌𝐀𝐑𝐄-                 --
--        -- https://t.me/Ha_ssin --         --
------------------------------------------------ 
...
ControllerAll = false
local ListSudos ={Sudo_Id,806201930}  
...
if UserId == 806201930 then
Status = true
elseif UserId == 806201930 then
Status = true
...
return {
Lock     = '[Hassan](https://t.me/GO_XXO)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[Hassan](https://t.me/GO_XXO)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[Hassan](https://t.me/GO_XXO)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[𝐍𝐈𝐆𝐇𝐓𝐌𝐀??𝐄](https://t.me/GO_XXO)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[Hassan](https://t.me/GO_XXO)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[Hassan](https://t.me/GO_XXO)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
if tonumber(msg.sender.user_id) == 806201930 then
...
{
{text = 'Hassan ⁦', url='https://t.me/GO_XXO'},
},
}
}
...
{{text =news,url = "https://t.me/GO_XXO"}, },}}
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/SX7786/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "متحركه" then
Abs = math.random(2,140); 
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendanimation?chat_id=' .. msg.chat_id .. '&animation=https://t.me//'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "شعر" then
Abs = math.random(2,140); 
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me//'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "ميمز" then
Abs = math.random(2,140); 
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me//'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
data = {
{
{text = '- قناة السورس', url = 't.me/GO_XXO'}, 
},
}
}
...
local UserId_Info = LuaTele.searchPublicChat("Ha_ssin")
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/Ha_ssin"}
},
{
{text = '❲ Hassan ❳', url = "https://t.me/GO_XXO"},
},
...
data = {
{
{text = 'Channel Source ،', url = 't.me/GO_XXO'}, 
},
{
{text = 'Annotations Source', url = 't.me/IE8IE8'}, 
},
{
{text = 'Communication Source', url = 't.me/Ha_ssin'}, 
},
{
{text = 'Developer Source !', url = 't.me/Ha_ssin'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
data = {
{
{text = '𝐍𝐈𝐆𝐇𝐓𝐌𝐀𝐑𝐄', url = 't.me/GO_XXO'}, 
},
}
}
...
data = {
{
{text = '᥀ السورس .', url = 't.me/GO_XXO'},{text = '᥀ لتنصيب بوت .', url = 't.me/Ha_ssin'}, 
},
{
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/SX7786/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
end
end
...
{
{text = '?? » { '..Mahibes3..' }', data = '/*'}, {text = '𝟒 » { '..Mahibes4..' }', data = '/*'}, 
},
{
