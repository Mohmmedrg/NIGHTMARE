...
return {
Lock     = '[- 𝗦𝗼𝘂𝗿𝗰𝗲 𝐍𝐈𝐆𝐇𝐓𝐌𝐀𝐑𝐄 .](https://t.me/IE7IE)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[- 𝗦𝗼𝘂𝗿𝗰𝗲 𝐍𝐈𝐆𝐇𝐓𝐌𝐀𝐑𝐄 .](https://t.me/IE7IE)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[- 𝗦𝗼𝘂𝗿𝗰𝗲 𝐍𝐈𝐆𝐇𝐓𝐌𝐀𝐑𝐄 .](https://t.me/IE7IE)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[- 𝗦𝗼𝘂𝗿𝗰𝗲 𝐍𝐈𝐆𝐇𝐓𝐌𝐀𝐑𝐄 .](https://t.me/IE7IE)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[- 𝗦𝗼𝘂𝗿𝗰𝗲 𝐍𝐈𝐆𝐇𝐓𝐌𝐀𝐑𝐄 .](https://t.me/IE7IE)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[- 𝗦𝗼𝘂𝗿𝗰𝗲 𝐍𝐈𝐆𝐇𝐓𝐌𝐀𝐑𝐄 .](https://t.me/IE7IE)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
{
{text = '『 𝗦𝗼𝘂𝗿𝗰𝗲 𝐍𝐈𝐆𝐇𝐓𝐌𝐀𝐑𝐄』', url = 't.me/IE7IE'},
},
}
}
if not msg.ControllerBot then
...
local T = '*𖥔 𝗦𝗼𝘂𝗿𝗰𝗲 𝐍𝐈𝐆𝐇𝐓𝐌𝐀𝐑𝐄:- *['..ban.first_name..'](tg://user?id='..ban.id..')**'
if photo.total_count > 0 then
keyboard = {} 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheKOIA..'K OIA:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n♡︙عليك الاشتراك  في قناة البوت لاستخذام الاوامر*',"md",f alse, false, false, false, reply_markup)
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
{
{text = '[𝟯]', data = msg.sender.user_id..'/help3'}, {text = '[𝟰]', data = msg.sen der.user_id..'/help4'}, 
},
{
